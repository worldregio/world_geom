...
Many list of countries are available in open source mapping packages (*gadm*, *natural earth*, ...) but with different lists of countries and also different geometries !
...
Another problem is the changing list of states over the period of observation. We will analyzed this problem in a separated chapter. 
